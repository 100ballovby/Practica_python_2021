...
| Команда     | Значение                                   |
+=============+============================================+
| forward(x) / fd(x)  | Пройти вперёд X пикселей           |
+-------------+--------------------------------------------+
| backward(x) / bk(x) | Пройти назад X пикселей            |
+-------------+--------------------------------------------+
| left(x) / lt(x)    | Повернуться налево на X градусов    |
+-------------+--------------------------------------------+
| right(x) / rt(x)    | Повернуться направо на X градусов  |
+-------------+--------------------------------------------+
| circle(r)   | Нарисовать окружность с радиусом r          |
+-------------+--------------------------------------------+
| dot(d)      | Нарисовать круг (закрашенный) с диаметром d |
+-------------+--------------------------------------------+
