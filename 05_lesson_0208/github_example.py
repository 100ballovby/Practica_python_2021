...
# домик
def draw_house():
    pygame.draw.line(screen, (0, 0, 0), [380, 350], [380, 200], 4)
    pygame.draw.line(screen, (0, 0, 0), [380, 200], [325, 200], 4)
    pygame.draw.line(screen, (0, 0, 0), [325, 200], [315, 210], 6)


# Звезда
def draw_ussr():
    pygame.draw.line(screen, (255, 0, 0), [130, 210], [165, 155], 5)
    pygame.draw.line(screen, (255, 0, 0), [165, 155], [100, 130], 5)
    pygame.draw.line(screen, (255, 0, 0), [100, 130], [165, 130], 5)
    pygame.draw.line(screen, (255, 0, 0), [165, 130], [180, 85], 5)
    pygame.draw.line(screen, (255, 0, 0), [180, 85], [195, 130], 5)
    pygame.draw.line(screen, (255, 0, 0), [195, 130], [260, 130], 5)
    pygame.draw.line(screen, (255, 0, 0), [260, 130], [195, 155], 5)
    pygame.draw.line(screen, (255, 0, 0), [195, 155], [230, 210], 5)
    pygame.draw.line(screen, (255, 0, 0), [230, 210], [180, 165], 6)
